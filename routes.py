...
def add_calc_date_range():
    ...
    # Now every jinja template will have access to a date_range variable defined above.
...
def index():
    ...
    habits_on_dates = current_app.db.habits.find({"added": {"$lte": selected_date}})
    completions = [
        habit["habit"]
